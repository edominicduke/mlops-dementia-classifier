...
"""
Preprocessing Decision #3: Binary encode the "M/F" column
...
"""
Preprocessing Decision #4: Binary encode the "Group" column
...
"""
Preprocessing Decision #5: Remove the "Subject ID" and "MRI ID" Columns
